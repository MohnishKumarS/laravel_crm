    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">
                    Only the version marked <strong>Active</strong> shows on the homepage. Keep old versions here as drafts/history if you like.
                </p>
                ...
                <table class="table table-striped">
                        ...
                        <tr>
                            <td style="width:70px;">
                                @if($section->image_main_url)
                                    <img src="{{ $section->image_main_url }}" style="width:60px;height:44px;object-fit:cover;border-radius:5px;">
                                @endif
                            </td>
                            <td>
                                {{ $section->heading }}
                            ...
                            <td class="text-right">
                                <a href="{{ route('admin.home-hero.edit', $section) }}" class="btn btn-sm btn-outline-secondary">Edit</a>
                                <form action="{{ route('admin.home-hero.destroy', $section) }}" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr><td colspan="5" class="text-center text-muted">No hero sections yet.</td></tr>
                    @endforelse
                    </tbody>
                </table>
