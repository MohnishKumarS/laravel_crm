...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><div class="card-title">Create Homepage Hero</div></div>
            <div class="card-body">
                ...
                <form action="{{ route('admin.home-hero.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            ...
                            <input name="heading" type="text" class="form-control" id="heading"
                                placeholder="The world celebrates brands. We celebrate" value="{{ old('heading') }}" required>
                    ...
                    <div id="buttons-repeater">
                        <div class="form-row repeater-row align-items-end mb-2">
                            <div class="form-group col-md-4 mb-0">
                                ...
                                <input type="text" name="button_text[]" class="form-control" placeholder="Explore Marketplace →">
                            </div>
                            <div class="form-group col-md-4 mb-0">
                                <label>Link URL</label>
                                <input type="text" name="button_url[]" class="form-control" placeholder="/marketplace">
                            </div>
                    ...
                    <div id="features-repeater">
                        <div class="form-row repeater-row align-items-end mb-2">
                            <div class="form-group col-md-3 mb-0">
                                <label>Title</label>
                                <input type="text" name="feature_title[]" class="form-control" placeholder="Shop">
                            </div>
                            <div class="form-group col-md-8 mb-0">
                                <label>Description</label>
                                <input type="text" name="feature_description[]" class="form-control" placeholder="Products, gifts & services">
                            </div>
                            <div class="form-group col-md-1 mb-0">
                                <button type="button" class="btn btn-outline-danger btn-sm remove-row">✕</button>
                            </div>
