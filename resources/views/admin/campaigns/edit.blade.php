                ...
                <form action="{{ route('admin.campaigns.update', $campaign) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="is_default" name="is_default" value="1"
                                    {{ old('is_default', $campaign->is_default) ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        @if($campaign->background_image)
                            <div class="mb-2"><img src="{{ $campaign->background_image_url }}" style="max-height:100px;border-radius:6px;"></div>
                        @endif
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="eyebrow" type="text" class="form-control" id="eyebrow" value="{{ old('eyebrow', $campaign->eyebrow) }}">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="badge_text">Badge text</label>
                            <input name="badge_text" type="text" class="form-control" id="badge_text" value="{{ old('badge_text', $campaign->badge_text) }}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-8">
                            <label for="heading">Heading</label>
                            <input name="heading" type="text" class="form-control" id="heading" value="{{ old('heading', $campaign->heading) }}" required>
                            @error('heading') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group col-md-4">
                            <label for="heading_highlight">Heading highlight</label>
                            <input name="heading_highlight" type="text" class="form-control" id="heading_highlight" value="{{ old('heading_highlight', $campaign->heading_highlight) }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-3">
                            ...
                            <input name="cta1_text" type="text" class="form-control" id="cta1_text" value="{{ old('cta1_text', $campaign->cta1_text) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="cta1_url">Primary button link</label>
                            <input name="cta1_url" type="text" class="form-control" id="cta1_url" value="{{ old('cta1_url', $campaign->cta1_url) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="cta2_text">Secondary button text</label>
                            <input name="cta2_text" type="text" class="form-control" id="cta2_text" value="{{ old('cta2_text', $campaign->cta2_text) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="cta2_url">Secondary button link</label>
                            <input name="cta2_url" type="text" class="form-control" id="cta2_url" value="{{ old('cta2_url', $campaign->cta2_url) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input name="announcement_text" type="text" class="form-control" id="announcement_text" value="{{ old('announcement_text', $campaign->announcement_text) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="announcement_link_text">Link text</label>
                            <input name="announcement_link_text" type="text" class="form-control" id="announcement_link_text" value="{{ old('announcement_link_text', $campaign->announcement_link_text) }}">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="announcement_link_url">Link URL</label>
                            <input name="announcement_link_url" type="text" class="form-control" id="announcement_link_url" value="{{ old('announcement_link_url', $campaign->announcement_link_url) }}">
                        </div>
                    </div>
