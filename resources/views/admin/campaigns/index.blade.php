                ...
                <table class="table table-striped">
                    ...
                    @forelse($campaigns as $campaign)
                        <tr>
                            ...
                            <td>
                                <span title="Gradient / accent" style="display:inline-block;width:16px;height:16px;border-radius:3px;background:{{ $campaign->theme_bg_start }};margin-right:2px;"></span>
                                <span style="display:inline-block;width:16px;height:16px;border-radius:3px;background:{{ $campaign->theme_bg_end }};margin-right:2px;"></span>
                                <span style="display:inline-block;width:16px;height:16px;border-radius:3px;background:{{ $campaign->accent_color }};"></span>
                            </td>
                    ...
                    @empty
                        <tr><td colspan="6" class="text-center text-muted">No campaigns yet — create one to get started.</td></tr>
                    @endforelse
                    </tbody>
                </table>
