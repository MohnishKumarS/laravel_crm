                    ...
                    <form action="{{ route('admin.campaigns.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <small class="form-text text-muted">If two campaigns' windows overlap, highest priority
                                    wins.</small>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="is_published">Published (visible to site
                                        visitors when in window)</label>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="is_default">Use as evergreen default (shown
                                        when no other campaign is active)</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input name="eyebrow" type="text" class="form-control" id="eyebrow"
                                    placeholder="Festival of Lights · Limited Time" value="{{ old('eyebrow') }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="badge_text">Badge text (optional pill)</label>
                                <input name="badge_text" type="text" class="form-control" id="badge_text"
                                    placeholder="DIWALI SALE · UP TO 40% OFF" value="{{ old('badge_text') }}">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                ...
                                <input name="heading" type="text" class="form-control" id="heading"
                                    placeholder="Gift handmade." value="{{ old('heading') }}" required>
                                @error('heading')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <input name="heading_highlight" type="text" class="form-control"
                                    id="heading_highlight" placeholder="Gift with meaning."
                                    value="{{ old('heading_highlight') }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="countdown_end_at" type="datetime-local" class="form-control"
                                    id="countdown_end_at" value="{{ old('countdown_end_at') }}">
