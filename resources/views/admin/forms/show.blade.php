        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-sm table-bordered">
                    <thead>
                        <tr><th>Name</th><th>Label</th><th>Type</th><th>Required</th></tr>
                    </thead>
                    <tbody>
                ...
                <table class="table table-sm table-bordered">
                    <thead>
                        <tr><th>#</th><th>Data</th><th>Submitted At</th></tr>
                    </thead>
                    <tbody>
                        @forelse ($form->submissions as $submission)
                            <tr>
                                <td>{{ $submission->id }}</td>
                                <td><pre class="mb-0">{{ json_encode($submission->data, JSON_PRETTY_PRINT) }}</pre></td>
