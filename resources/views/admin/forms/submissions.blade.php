                        ...
                        <thead>
                            <tr>
                                ...
                                @foreach ($form->fields as $field)
                                    @if (!empty($field['name']))
                                        <th data-type="{{ $field['type'] }}">{{ $field['label'] ?? $field['name'] }}</th>
                                    @endif
                                @endforeach
...
$(document).ready(function () {
    ...
    $('#submissions-table tfoot th').each(function (i) {
        ...
        if (fieldType === 'select' || fieldType === 'checkbox') {
            $(this).html('<select class="form-control form-control-sm column-filter"><option value="">All</option></select>');
        } else {
            $(this).html(`<input type="text" class="form-control form-control-sm column-filter" placeholder="Filter ${title}" />`);
        }
    });
