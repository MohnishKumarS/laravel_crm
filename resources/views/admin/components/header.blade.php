            ...
            <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                        ...
                        <li>
                            <div class="message-notif-scroll scrollbar-outer">
                                <div class="notif-center">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('yuukke/assets/img/chadengle.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('yuukke/assets/img/mlane.jpg') }}" alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('yuukke/assets/img/talha.jpg') }}" alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                            ...
                            <div class="notif-scroll scrollbar-outer">
                                <div class="notif-center">
                                    ...
                                    <a href="#">
                                        ...
                                        <div class="notif-content">
                                            <span class="block"> Farrah liked yuukke </span>
                                            <span class="time">17 minutes ago</span>
                                        </div>
                                    </a>
                                </div>
                ...
                <li class="nav-item topbar-user dropdown hidden-caret">
                    <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                        aria-expanded="false">
                        <div class="avatar-sm">
                            <img src="{{ asset('uploads/favicon/favicon-32x32.png') }}" alt="..."
